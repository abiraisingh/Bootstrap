...
### **index.html**
- Includes Bootstrap 5 CSS & JS through CDN links  
- Contains:
  - A title and paragraph section
  - A Bootstrap-styled table
  - Basic container and row structure

It is simple, clean, and perfect for practicing layout design.
